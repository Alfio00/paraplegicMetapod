!(function (e) {
    ...
    function u(e) {
        ...
        var o = function (o) {
                return (
                    t.hot.active
                        ? (A[o] ? -1 === A[o].parents.indexOf(e) && A[o].parents.push(e) : ((a = [e]), (n = o)), -1 === t.children.indexOf(o) && t.children.push(o))
                        : (console.warn("[HMR] unexpected require(" + o + ") from disposed module " + e), (a = [])),
                    V(o)
                );
            },
            r = function (e) {
    ...
    function C(t) {
                ...
                if ((c = A[i]) && !c.hot._selfAccepted) {
                    ...
                    for (var a = 0; a < c.parents.length; a++) {
                        var u = c.parents[a],
                            l = A[u];
                        if (l) {
                            if (l.hot._declinedDependencies[i]) return { type: "declined", chain: s.concat([u]), moduleId: i, parentId: u };
                            -1 === t.indexOf(u) && (l.hot._acceptedDependencies[i] ? (n[u] || (n[u] = []), h(n[u], [i])) : (delete n[u], t.push(u), o.push({ chain: s.concat([u]), id: u })));
                        }
                    }
                }
            }
        ...
        for (var b in f)
            if (Object.prototype.hasOwnProperty.call(f, b)) {
                ...
                var P = !1,
                    ...
                    T = !1,
                    G = "";
                switch (((_ = f[b] ? l(u) : { type: "disposed", moduleId: b }).chain && (G = "\nUpdate propagation: " + _.chain.join(" -> ")), _.type)) {
                    case "self-declined":
                ...
                if (C) for (u in ((v[u] = f[u]), h(m, _.outdatedModules), _.outdatedDependencies)) Object.prototype.hasOwnProperty.call(_.outdatedDependencies, u) && (y[u] || (y[u] = []), h(y[u], _.outdatedDependencies[u]));
                T && (h(m, [_.moduleId]), (v[u] = S));
            }
        var E,
            L = [];
        for (o = 0; o < m.length; o++) (u = m[o]), A[u] && A[u].hot._selfAccepted && L.push({ module: u, errorHandler: A[u].hot._selfAccepted });
        p("dispose"),
        ...
        for (u in y) if (Object.prototype.hasOwnProperty.call(y, u) && (c = A[u])) for (I = y[u], i = 0; i < I.length; i++) (O = I[i]), (E = c.children.indexOf(O)) >= 0 && c.children.splice(E, 1);
            ...
            if (Object.prototype.hasOwnProperty.call(y, u) && (c = A[u])) {
                ...
                for (o = 0; o < N.length; o++) {
                    ...
                    try {
                        ...
                        t.onErrored && t.onErrored({ type: "accept-errored", moduleId: u, dependencyId: I[o], error: e }), t.ignoreErrored || B || (B = e);
                    }
                }
            }
            ...
            try {
                ...
                if ("function" == typeof H.errorHandler)
                    try {
                        ...
                        t.onErrored && t.onErrored({ type: "self-accept-error-handler-errored", moduleId: u, error: n, originalError: e }), t.ignoreErrored || B || (B = n), B || (B = e);
                    }
                else t.onErrored && t.onErrored({ type: "self-accept-errored", moduleId: u, error: e }), t.ignoreErrored || B || (B = e);
            }
        }
        return B
            ...
            hot: (function (e) {
                var t = {
                    ...
                    accept: function (e, n) {
                        ...
                        else if ("object" == typeof e) for (var o = 0; o < e.length; o++) t._acceptedDependencies[e[o]] = n || function () {};
    ...
    (V.m = e),
        (V.c = A),
        (V.d = function (e, t, n) {
            V.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: n });
        }),
        (V.r = function (e) {
        ...
        (V.t = function (e, t) {
            ...
            if ((V.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e))
                for (var o in e)
                    V.d(
                        n,
                        o,
    ...
    "./node_modules/jquery/dist/jquery.js": function (e, t, n) {
        ...
        !(function (t, n) {
            ...
            function x(e, t, n) {
                ...
                if (((r.text = e), n)) for (o in w) n[o] && (r[o] = n[o]);
                    ...
                    for ("boolean" == typeof s && ((u = s), (s = arguments[a] || {}), a++), "object" == typeof s || v(s) || (s = {}), a === c && ((s = this), a--); a < c; a++)
                        if (null != (e = arguments[a]))
                            for (t in e)
                                (n = s[t]),
                                    s !== (o = e[t]) &&
                                        (u && o && (_.isPlainObject(o) || (r = Array.isArray(o)))
                                            ? (r ? ((r = !1), (i = n && Array.isArray(n) ? n : [])) : (i = n && _.isPlainObject(n) ? n : {}), (s[t] = _.extend(u, i, o)))
                                            : void 0 !== o && (s[t] = o));
                    return s;
                }),
                _.extend({
                    ...
                    each: function (e, t) {
                        var n,
                            o = 0;
                        if (C(e)) for (n = e.length; o < n && !1 !== t.call(e[o], o, e[o]); o++);
                    ...
                    map: function (e, t, n) {
                        var o,
                            ...
                            i = 0,
                            s = [];
                        if (C(e)) for (o = e.length; i < o; i++) null != (r = t(e[i], i, n)) && s.push(r);
            ...
            var A =
                ...
                (function (e) {
                    ...
                    (p = ie.setDocument = function (e) {
                        ...
                        return s !== h && 9 === s.nodeType && s.documentElement
                            ? ((f = (h = s).documentElement),
                              ...
                              (n.matchesSelector = Y.test((v = f.matches || f.webkitMatchesSelector || f.mozMatchesSelector || f.oMatchesSelector || f.msMatchesSelector))) &&
                                  ce(function (e) {
                                  ...
                                  ? function (e, t) {
                                        ...
                                        return (
                                            ...
                                            (1 & (o = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!n.sortDetached && t.compareDocumentPosition(e) === o)
                                                ? e === h || (e.ownerDocument === x && S(x, e))
                                                    ? -1
                                                    : t === h || (t.ownerDocument === x && S(x, t))
                                                    ? 1
                                                    : l
                                                    ? R(l, e) - R(l, t)
                                                    : 0
                    ...
                    (ie.matchesSelector = function (e, t) {
                        if (((e.ownerDocument || e) !== h && p(e), (t = t.replace(U, "='$1']")), n.matchesSelector && g && !A[t + " "] && (!m || !m.test(t)) && (!y || !y.test(t))))
                            try {
                                var o = v.call(e, t);
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function (e) {
                                ...
                                return z.CHILD.test(e[0])
                                    ? null
                                    : (e[3] ? (e[2] = e[4] || e[5] || "") : n && W.test(n) && (t = s(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                            },
                        },
                        filter: {
                            TAG: function (e) {
                                    ...
                                    : function (t, n, c) {
                                          ...
                                          if (y) {
                                              ...
                                              if (((f = [s ? y.firstChild : y.lastChild]), s && v)) {
                                                  for (
                                                      S = (h = (u = (l = (d = (p = y)[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === b && u[1]) && u[2], p = h && y.childNodes[h];
                                                      (p = (++h && p && p[g]) || (S = h = 0) || f.pop());
                                                  ...
                                                  for (
                                                      ;
                                                      (p = (++h && p && p[g]) || (S = h = 0) || f.pop()) &&
                                                      ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++S || (v && ((l = (d = p[w] || (p[w] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] = [b, S]), p !== t));
                    ...
                    function ve(e, t, n) {
                        ...
                        return t.first
                            ? function (t, n, r) {
                                  for (; (t = t[o]); ) if (1 === t.nodeType || s) return e(t, n, r);
                                  return !1;
                              }
                            : function (t, n, c) {
                                  var u,
                                      ...
                                      p = [b, a];
                                  if (c) {
                                      for (; (t = t[o]); ) if ((1 === t.nodeType || s) && e(t, n, c)) return !0;
                                  } else
                                      for (; (t = t[o]); )
                                          if (1 === t.nodeType || s)
                        ...
                        return (
                            ...
                            ae(function (i, s, a, c) {
                                var u,
                                    ...
                                    m = n ? (r || (i ? e : f || o) ? [] : s) : y;
                                if ((n && n(y, m, a, c), o)) for (u = we(m, h), o(u, [], a, c), l = u.length; l--; ) (d = u[l]) && (m[h[l]] = !(y[h[l]] = d));
                                if (i) {
                                    if (r || e) {
                                        if (r) {
                        ...
                        for (
                            ...
                            if ((n = o.relative[e[c].type])) p = [ve(Se(p), n)];
                                ...
                                if ((n = o.filter[e[c].type].apply(null, e[c].matches))[w]) {
                                    ...
                                    return xe(
                                        c > 1 && Se(p),
                                        c > 1 && me(e.slice(0, c - 1).concat({ value: " " === e[c - 2].type ? "*" : "" })).replace(D, "$1"),
                                        n,
                                        c < r && be(e.slice(c, r)),
                                        r < i && be((e = e.slice(r))),
                                        r < i && me(e)
                    ...
                    return (
                        ...
                        (s = ie.tokenize = function (e, t) {
                            ...
                            for (a = e, c = [], u = o.preFilter; a; ) {
                                for (s in ((n && !(r = q.exec(a))) || (r && (a = a.slice(r[0].length) || a), c.push((i = []))),
                                (n = !1),
                                (r = F.exec(a)) && ((n = r.shift()), i.push({ value: n, type: r[0].replace(D, " ") }), (a = a.slice(n.length))),
                                o.filter))
                                    !(r = z[s].exec(a)) || (u[s] && !(r = u[s](r))) || ((n = r.shift()), i.push({ value: n, type: s, matches: r }), (a = a.slice(n.length)));
                                if (!n) break;
                            }
                                        ...
                                        var n = t.length > 0,
                                            ...
                                            i = function (i, s, a, c, l) {
                                                ...
                                                if (((m += v), n && v !== m)) {
                                                    ...
                                                    if (i) {
                                                        if (m > 0) for (; v--; ) S[v] || w[v] || (w[v] = E.call(c));
                                                        w = we(w);
                                                    }
            ...
            (_.Callbacks = function (e) {
                ...
                var t,
                    ...
                    a = -1,
                    c = function () {
                        for (r = r || e.once, o = t = !0; s.length; a = -1) for (n = s.shift(); ++a < i.length; ) !1 === i[a].apply(n[0], n[1]) && e.stopOnFalse && ((a = i.length), (n = !1));
                                                ...
                                                u = function () {
                                                    ...
                                                    if (!(e < i)) {
                                                        ...
                                                        (u = n && ("object" == typeof n || "function" == typeof n) && n.then),
                                                            v(u)
                                                                ? r
                                                                    ? u.call(n, s(i, t, N, r), s(i, t, H, r))
                                                                    : (i++, u.call(n, s(i, t, N, r), s(i, t, H, r), s(i, t, N, t.notifyWith)))
                                                                : (o !== N && ((a = void 0), (c = [n])), (r || t.resolveWith)(a, c));
                                                    }
                                                },
                                                l = r
                                                    ? u
            ...
            (_.fn.ready = function (e) {
                ...
                (_.ready.then = F.then),
                "complete" === s.readyState || ("loading" !== s.readyState && !s.documentElement.doScroll) ? n.setTimeout(_.ready) : (s.addEventListener("DOMContentLoaded", U), n.addEventListener("load", U));
            var W = function (e, t, n, o, r, i, s) {
                    var a = 0,
                        c = e.length,
                        u = null == n;
                    if ("object" === b(n)) for (a in ((r = !0), n)) W(e, t, a, n[a], !0, i, s);
                    else if (
                        void 0 !== o &&
                        ((r = !0),
                        v(o) || (s = !0),
            ...
            function ce(e, t, n, o) {
                ...
                if (l && l[3] !== u) {
                    for (c /= 2, u = u || l[3], l = +c || 1; s--; ) _.style(e, t, l + u), (1 - i) * (1 - (i = a() / c || 0.5)) <= 0 && (s = 0), (l /= i);
            ...
            function de(e, t) {
                for (var n, o, r = [], i = 0, s = e.length; i < s; i++)
                    (o = e[i]).style &&
                        ((n = o.style.display),
                        t ? ("none" === n && ((r[i] = K.get(o, "display") || null), r[i] || (o.style.display = "")), "" === o.style.display && se(o) && (r[i] = le(o))) : "none" !== n && ((r[i] = "none"), K.set(o, "display", n)));
            ...
            function Se(e, t, n, o, r) {
                ...
                for (d.textContent = "", h = 0; (i = p[h++]); )
                    ...
                    else if (((u = _.contains(i.ownerDocument, i)), (s = ye(d.appendChild(i), "script")), u && me(s), n)) for (l = 0; (i = s[l++]); ) fe.test(i.type || "") && n.push(i);
                return d;
            }
            !(function () {
                        ...
                        for (
                            ...
                            (h = g = (a = _e.exec(t[u]) || [])[1]),
                                ...
                                h &&
                                    ...
                                    (d = _.event.special[h] || {}),
                                    (l = _.extend({ type: h, origType: g, data: o, handler: n, guid: n.guid, selector: r, needsContext: r && _.expr.match.needsContext.test(r), namespace: f.join(".") }, i)),
                                    (p = c[h]) || (((p = c[h] = []).delegateCount = 0), (d.setup && !1 !== d.setup.call(e, o, f, s)) || (e.addEventListener && e.addEventListener(h, s))),
                    ...
                    if (y && (c = y.events)) {
                        for (u = (t = (t || "").match(B) || [""]).length; u--; )
                            if (((h = g = (a = _e.exec(t[u]) || [])[1]), (f = (a[2] || "").split(".").sort()), h)) {
                                for (d = _.event.special[h] || {}, p = c[(h = (o ? d.delegateType : d.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = i = p.length; i--; )
                                    (l = p[i]),
                                        (!r && g !== l.origType) ||
                                            (n && n.guid !== l.guid) ||
                            ...
                            } else for (h in c) _.event.remove(e, h + t[u], n, o, !0);
                        ...
                        for (s = _.event.handlers.call(this, a, u), t = 0; (r = s[t++]) && !a.isPropagationStopped(); )
                            for (a.currentTarget = r.elem, n = 0; (i = r.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                                (a.rnamespace && !a.rnamespace.test(i.namespace)) ||
                                    ((a.handleObj = i), (a.data = i.data), void 0 !== (o = ((_.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, c)) && !1 === (a.result = o) && (a.preventDefault(), a.stopPropagation()));
            ...
            function ke(e, t) {
                var n, o, r, i, s, a, c, u;
                if (1 === t.nodeType) {
                    if (K.hasData(e) && ((i = K.access(e)), (s = K.set(t, i)), (u = i.events))) for (r in (delete s.handle, (s.events = {}), u)) for (n = 0, o = u[r].length; n < o; n++) _.event.add(t, r, u[r][n]);
            ...
            function je(e, t, n, o) {
                ...
                if (p && ((i = (r = Se(t, e[0].ownerDocument, !1, e, o)).firstChild), 1 === r.childNodes.length && (r = i), i || o)) {
                    ...
                    if (a)
                        for (l = s[s.length - 1].ownerDocument, _.map(s, Re), d = 0; d < a; d++)
                            (c = s[d]),
            ...
            _.extend({
                ...
                clone: function (e, t, n) {
                    ...
                    if (!(m.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || _.isXMLDoc(e))) for (s = ye(a), o = 0, r = (i = ye(e)).length; o < r; o++) Me(i[o], s[o]);
                    if (t)
                        if (n) for (i = i || ye(e), s = s || ye(a), o = 0, r = i.length; o < r; o++) ke(i[o], s[o]);
                        else ke(e, a);
                ...
                cleanData: function (e) {
                    for (var t, n, o, r = _.event.special, i = 0; void 0 !== (n = e[i]); i++)
                        if (Y(n)) {
                            if ((t = n[K.expando])) {
                                if (t.events) for (o in t.events) r[o] ? _.event.remove(n, o) : _.removeEvent(n, o, t.handle);
                                n[K.expando] = void 0;
                            }
            ...
            function qe(e, t, n) {
                ...
                return (
                    (n = n || He(e)) &&
                        ...
                        !m.pixelBoxStyles() && Ne.test(s) && De.test(t) && ((o = a.width), (r = a.minWidth), (i = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = o), (a.minWidth = r), (a.maxWidth = i))),
                    void 0 !== s ? s + "" : s
                );
            }
            function Fe(e, t) {
            ...
            function Ke(e, t, n, o, r, i) {
                ...
                for (; s < 4; s += 2)
                    "margin" === n && (c += _.css(e, n + ie[s], !0, r)),
                        o
                            ? ("content" === n && (c -= _.css(e, "padding" + ie[s], !0, r)), "margin" !== n && (c -= _.css(e, "border" + ie[s] + "Width", !0, r)))
                            : ((c += _.css(e, "padding" + ie[s], !0, r)), "padding" !== n ? (c += _.css(e, "border" + ie[s] + "Width", !0, r)) : (a += _.css(e, "border" + ie[s] + "Width", !0, r)));
                return !o && i >= 0 && (c += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - i - c - a - 0.5))), c;
            }
            function Je(e, t, n) {
                var o = He(e),
                    r = qe(e, t, o),
                ...
                return (
                    ...
                    ("auto" === r || (!parseFloat(r) && "inline" === _.css(e, "display", !1, o))) && ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = !0)),
            ...
            _.extend({
                ...
                style: function (e, t, n, o) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        ...
                        "string" === (i = typeof n) && (r = re.exec(n)) && r[1] && ((n = ce(e, t, r)), (i = "number")),
                            null != n &&
                                n == n &&
                                ("number" === i && (n += (r && r[3]) || (_.cssNumber[a] ? "" : "px")),
                ...
                _.each(["height", "width"], function (e, t) {
                    _.cssHooks[t] = {
                        get: function (e, n, o) {
                            if (n)
                                return !Ue.test(_.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                                    ? Je(e, t, o)
                                    : ae(e, Qe, function () {
                                          return Je(e, t, o);
                                      });
                        ...
                        set: function (e, n, o) {
                            var r,
                                ...
                                a = o && Ke(e, t, o, s, i);
                            return (
                                s && m.scrollboxSize() === i.position && (a -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - Ke(e, t, "border", !1, i) - 0.5)),
                                a && (r = re.exec(n)) && "px" !== (r[3] || "px") && ((e.style[t] = n), (n = _.css(e, t))),
                                Ze(0, n, a)
                            );
                        },
                    };
            ...
            function ct(e, t, n) {
                for (var o, r = (ut.tweeners[t] || []).concat(ut.tweeners["*"]), i = 0, s = r.length; i < s; i++) if ((o = r[i].call(n, t, e))) return o;
            }
            function ut(e, t, n) {
                var o,
                    r,
                ...
                return (
                    ...
                    _.fx.timer(_.extend(c, { elem: e, anim: u, queue: u.opts.queue })),
                    u
                );
            }
            (_.Animation = _.extend(ut, {
                    ...
                    function (e, t, n) {
                        ...
                        if ((c = !_.isEmptyObject(t)) || !_.isEmptyObject(h))
                            for (o in (d &&
                                ...
                                "none" === (l = _.css(e, "display")) && (u ? (l = u) : (de([e], !0), (u = e.style.display || u), (l = _.css(e, "display")), de([e]))),
                            ...
                            h))
                                c ||
                                    (y ? "hidden" in y && (g = y.hidden) : (y = K.access(e, "fxshow", { display: u })),
                                    i && (y.hidden = !g),
                                    g && de([e], !0),
                                    p.done(function () {
                                    ...
                                    (c = ct(g ? y[o] : 0, o, p)),
                                    o in y || ((y[o] = c.start), g && ((c.end = c.start), (c.start = 0)));
                    },
                ],
                ...
                (_.speed = function (e, t, n) {
                    var o = e && "object" == typeof e ? _.extend({}, e) : { complete: n || (!n && t) || (v(e) && e), duration: e, easing: (n && t) || (t && !v(t) && t) };
                    return (
                ...
                _.fn.extend({
                    fadeTo: function (e, t, n, o) {
                        return this.filter(se).css("opacity", 0).show().end().animate({ opacity: t }, e, n, o);
                    },
                    ...
                    stop: function (e, t, n) {
                        ...
                        return (
                            ...
                            this.each(function () {
                                ...
                                else for (r in s) s[r] && s[r].stop && rt.test(r) && o(s[r]);
                    ...
                    attr: function (e, t, n) {
                        ...
                        if (3 !== i && 8 !== i && 2 !== i)
                            return void 0 === e.getAttribute
                                ? _.prop(e, t, n)
                                : ((1 === i && _.isXMLDoc(e)) || (r = _.attrHooks[t.toLowerCase()] || (_.expr.match.bool.test(t) ? lt : void 0)),
                                  void 0 !== n
                                      ? null === n
            ...
            _.fn.extend({
                ...
                _.extend({
                    prop: function (e, t, n) {
                        ...
                        if (3 !== i && 8 !== i && 2 !== i)
                            return (
                                (1 === i && _.isXMLDoc(e)) || ((t = _.propFix[t] || t), (r = _.propHooks[t])),
                ...
                _.fn.extend({
                    ...
                    toggleClass: function (e, t) {
                        ...
                        return "boolean" == typeof t && o
                            ...
                            : this.each(function () {
                                  var t, r, i, s;
                                  if (o) for (r = 0, i = _(this), s = yt(e); (t = s[r++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                    ...
                    hasClass: function (e) {
                        var t,
                            n,
                            o = 0;
                        for (t = " " + e + " "; (n = this[o++]); ) if (1 === n.nodeType && (" " + ft(gt(n)) + " ").indexOf(t) > -1) return !0;
                        return !1;
                    },
                });
            var mt = /\r/g;
                    ...
                    if (
                        ...
                        for (i = 0; (a = g[i++]) && !e.isPropagationStopped(); )
                            (h = a),
                                ...
                                (d = l && a[l]) && d.apply && Y(a) && ((e.result = d.apply(a, t)), !1 === e.result && e.preventDefault());
                        return (
                            (e.type = y),
                            r ||
            ...
            function Vt(e, t, n, o) {
                ...
                else for (r in t) Vt(e + "[" + r + "]", t[r], n, o);
            }
            ...
            (jt.href = wt.href),
                    ...
                    ajax: function (e, t) {
                        ...
                        f.hasContent
                            ...
                            : ((h = f.url.slice(r.length)),
                              ...
                              !1 === f.cache && ((r = r.replace(Et, "$1")), (h = (bt.test(r) ? "&" : "?") + "_=" + xt++ + h)),
                              (f.url = r + h)),
                        f.ifModified && (_.lastModified[r] && P.setRequestHeader("If-Modified-Since", _.lastModified[r]), _.etag[r] && P.setRequestHeader("If-None-Match", _.etag[r])),
                        ...
                        function C(e, t, s, a) {
                            ...
                            l ||
                                ...
                                s &&
                                    (w = (function (e, t, n) {
                                        for (var o, r, i, s, a = e.contents, c = e.dataTypes; "*" === c[0]; ) c.shift(), void 0 === o && (o = e.mimeType || t.getResponseHeader("Content-Type"));
                                        if (o)
                                            for (r in a)
                                                if (a[r] && a[r].test(o)) {
                                                    c.unshift(r);
                                                ...
                                                if (!0 !== s)
                                                    if (s && e.throws) t = s(t);
                                                        ...
                                                        try {
                                                            ...
                                                            return { state: "parsererror", error: s ? e : "No conversion from " + c + " to " + i };
                                                        }
                                            }
                                    return { state: "success", data: t };
                                })(f, w, P, u)),
                                u
                                    ? (f.ifModified && ((x = P.getResponseHeader("Last-Modified")) && (_.lastModified[r] = x), (x = P.getResponseHeader("etag")) && (_.etag[r] = x)),
                                      204 === e || "HEAD" === f.type ? (b = "nocontent") : 304 === e ? (b = "notmodified") : ((b = w.state), (p = w.data), (u = !(h = w.error))))
                                    : ((h = b), (!e && b) || ((b = "error"), e < 0 && (e = 0))),
                                (P.status = e),
                                (P.statusText = (t || b) + ""),
                                ...
                                v.fireWith(g, [P, b]),
                                d && (y.trigger("ajaxComplete", [P, f]), --_.active || _.event.trigger("ajaxStop")));
                        }
                        return P;
                    },
                ...
                _.each(["get", "post"], function (e, t) {
                    _[t] = function (e, n, o, r) {
                        return v(n) && ((r = r || o), (o = n), (n = void 0)), _.ajax(_.extend({ url: e, type: t, dataType: r, data: n, success: o }, _.isPlainObject(e) && e));
                    };
                }),
                        ...
                        return {
                            send: function (r, i) {
                                ...
                                (t = function (e) {
                                    return function () {
                                        t &&
                                            ((t = o = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null),
                                            "abort" === e
                                                ? a.abort()
                                                : "error" === e
            ...
            _.ajaxSetup({
                ...
                (_.parseHTML = function (e, t, n) {
                    return "string" != typeof e
                        ...
                        : ("boolean" == typeof t && ((n = t), (t = !1)),
                          t || (m.createHTMLDocument ? (((o = (t = s.implementation.createHTMLDocument("")).createElement("base")).href = s.location.href), t.head.appendChild(o)) : (t = s)),
                          (r = L.exec(e)),
                          (i = !n && []),
                          r ? [t.createElement(r[1])] : ((r = Se([e], t, i)), i && i.length && _(i).remove(), _.merge([], r.childNodes)));
                    var o, r, i;
                }),
                (_.fn.load = function (e, t, n) {
                    var o,
                        ...
                        a = e.indexOf(" ");
                    return (
                        a > -1 && ((o = ft(e.slice(a))), (e = e.slice(0, a))),
                ...
                (_.offset = {
                    setOffset: function (e, t, n) {
                        ...
                        "static" === u && (e.style.position = "relative"),
                            ...
                            (i = _.css(e, "top")),
                            (c = _.css(e, "left")),
                            ("absolute" === u || "fixed" === u) && (i + c).indexOf("auto") > -1 ? ((s = (o = l.position()).top), (r = o.left)) : ((s = parseFloat(i) || 0), (r = parseFloat(c) || 0)),
                ...
                _.fn.extend({
                    ...
                    position: function () {
                        if (this[0]) {
                            ...
                            return { top: t.top - r.top - _.css(o, "marginTop", !0), left: t.left - r.left - _.css(o, "marginLeft", !0) };
                        }
                    },
                    ...
                    })()(
                        {
                                    ...
                                    !(function () {
                                        ...
                                        var e = function (e, t) {
                                            (t = t || {}),
                                                ...
                                                o.set(e, { axes: t.axes || e.axes, area: t.area || e.area, mass: t.mass || e.mass, inertia: t.inertia || e.inertia });
                                            ...
                                            (o.rotate = function (e, t, n) {
                                                if (n) {
                                                    var r = Math.cos(t),
                                                        ...
                                                        s = e.position.x - n.x,
                                                        a = e.position.y - n.y;
                                                    o.setPosition(e, { x: n.x + (s * r - a * i), y: n.y + (s * i + a * r) }), o.setAngle(e, e.angle + t);
                                            ...
                                            (o.update = function (e, t, n, o) {
                                                ...
                                                for (var p = 0; p < e.parts.length; p++) {
                                                    ...
                                                    r.translate(h.vertices, e.velocity),
                                                        p > 0 && ((h.position.x += e.velocity.x), (h.position.y += e.velocity.y)),
                                                        0 !== e.angularVelocity &&
                                                            (r.rotate(h.vertices, e.angularVelocity, e.position), u.rotate(h.axes, e.angularVelocity), p > 0 && i.rotateAbout(h.position, e.angularVelocity, e.position, h.position)),
                            ...
                            2: [
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.create = function (e) {
                                            return i.extend({ id: i.nextId(), type: "composite", parent: null, isModified: !1, bodies: [], constraints: [], composites: [], label: "Composite", plugin: {} }, e);
                                        }),
                                            ...
                                            (o.removeComposite = function (e, t, n) {
                                                ...
                                                if ((-1 !== r && (o.removeCompositeAt(e, r), o.setModified(e, !0, !0, !1)), n)) for (var s = 0; s < e.composites.length; s++) o.removeComposite(e.composites[s], t, !0);
                                                return e;
                                            }),
                                            ...
                                            (o.removeBody = function (e, t, n) {
                                                ...
                                                if ((-1 !== r && (o.removeBodyAt(e, r), o.setModified(e, !0, !0, !1)), n)) for (var s = 0; s < e.composites.length; s++) o.removeBody(e.composites[s], t, !0);
                                                return e;
                                            }),
                                            ...
                                            (o.removeConstraint = function (e, t, n) {
                                                ...
                                                if ((-1 !== r && o.removeConstraintAt(e, r), n)) for (var s = 0; s < e.composites.length; s++) o.removeConstraint(e.composites[s], t, !0);
                                                return e;
                                            }),
                                            ...
                                            (o.clear = function (e, t, n) {
                                                if (n) for (var r = 0; r < e.composites.length; r++) o.clear(e.composites[r], t, !0);
                                                return (
                                                    t
                                            ...
                                            (o.rotate = function (e, t, n, r) {
                                                for (var i = Math.cos(t), s = Math.sin(t), c = r ? o.allBodies(e) : e.bodies, u = 0; u < c.length; u++) {
                                                    var l = c[u],
                                                        d = l.position.x - n.x,
                                                        p = l.position.y - n.y;
                                                    a.setPosition(l, { x: n.x + (d * i - p * s), y: n.y + (d * s + p * i) }), a.rotate(l, t);
                                                }
                                                return o.setModified(e, !0, !0, !1), e;
                                            }),
                                            (o.scale = function (e, t, n, r, i) {
                                                for (var s = i ? o.allBodies(e) : e.bodies, c = 0; c < s.length; c++) {
                                                    var u = s[c],
                                                        l = u.position.x - r.x,
                                                        d = u.position.y - r.y;
                                                    a.setPosition(u, { x: r.x + l * t, y: r.y + d * n }), a.scale(u, t, n);
                                                }
                                                return o.setModified(e, !0, !0, !1), e;
                                            }),
                                            (o.bounds = function (e) {
                            ...
                            6: [
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.create = function (e) {
                                            var t = { controller: o, detector: i.collisions, buckets: {}, pairs: {}, pairsList: [], bucketWidth: 48, bucketHeight: 48 };
                                            return s.extend(t, e);
                                        }),
                                            ...
                                            (o._createRegion = function (e, t, n, o) {
                                                return { id: e + "," + t + "," + n + "," + o, startCol: e, endCol: t, startRow: n, endRow: o };
                                            }),
                                ...
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o._pairMaxIdleLife = 1e3),
                                            (o.create = function (e) {
                                                return i.extend({ table: {}, list: [], collisionStart: [], collisionActive: [], collisionEnd: [] }, e);
                                            }),
                                            (o.update = function (e, t, n) {
                                                var o,
                                                    s,
                                                    ...
                                                    h = e.collisionActive,
                                                    f = [];
                                                for (d.length = 0, p.length = 0, h.length = 0, c = 0; c < t.length; c++)
                                                    (o = t[c]).collided &&
                                                        ((s = r.id(o.bodyA, o.bodyB)), f.push(s), (a = l[s]) ? (a.isActive ? h.push(a) : d.push(a), r.update(a, o, n)) : ((a = r.create(o, n)), (l[s] = a), d.push(a), u.push(a)));
                                    ...
                                    !(function () {
                                        (o.collides = function (e, t) {
                                            ...
                                            (o.ray = function (e, t, n, i) {
                                                i = i || 1e-100;
                                                for (
                                                    var s = r.angle(t, n), c = r.magnitude(r.sub(t, n)), u = 0.5 * (n.x + t.x), l = 0.5 * (n.y + t.y), d = a.rectangle(u, l, c, i, { angle: s }), p = o.collides(d, e), h = 0;
                                                    h < p.length;
                                                    h += 1
                                                ) {
                                                    var f = p[h];
                                            ...
                                            (o.solvePosition = function (e, t) {
                                                ...
                                                for (n = 0; n < e.length; n++)
                                                    (r = e[n]).isActive &&
                                                        ...
                                                        a.isStatic || a.isSleeping || ((d = o._positionDampen / a.totalContacts), (a.positionImpulse.x += u.x * p * d), (a.positionImpulse.y += u.y * p * d)),
                                                        c.isStatic || c.isSleeping || ((d = o._positionDampen / c.totalContacts), (c.positionImpulse.x -= u.x * p * d), (c.positionImpulse.y -= u.y * p * d)));
                                            }),
                                                ...
                                                for (var t = 0; t < e.length; t++) {
                                                    ...
                                                    if (((n.totalContacts = 0), 0 !== n.positionImpulse.x || 0 !== n.positionImpulse.y)) {
                                                        ...
                                                        (n.positionPrev.x += n.positionImpulse.x),
                                                            ...
                                                            i.dot(n.positionImpulse, n.velocity) < 0
                                                                ? ((n.positionImpulse.x = 0), (n.positionImpulse.y = 0))
                                                                : ((n.positionImpulse.x *= o._positionWarming), (n.positionImpulse.y *= o._positionWarming));
                                                    }
                                                }
                                            }),
                                            (o.preSolveVelocity = function (e) {
                                                ...
                                                for (t = 0; t < e.length; t++)
                                                    if ((o = e[t]).isActive && !o.isSensor)
                                                        for (r = o.activeContacts, s = o.collision, a = s.parentA, c = s.parentB, u = s.normal, l = s.tangent, n = 0; n < r.length; n++)
                                                            (d = r[n]),
                                                                (p = d.vertex),
                                                                (h = d.normalImpulse),
                                                                (f = d.tangentImpulse),
                                                ...
                                                for (var n = t * t, r = i._temp[0], a = i._temp[1], c = i._temp[2], u = i._temp[3], l = i._temp[4], d = i._temp[5], p = 0; p < e.length; p++) {
                                                    ...
                                                    if (h.isActive && !h.isSensor) {
                                                        ...
                                                        for (var x = 0; x < S.length; x++) {
                                                            ...
                                                            (r.x = m.x * I + v.x * k),
                                                                (r.y = m.y * I + v.y * k),
                                                                g.isStatic || g.isSleeping || ((g.positionPrev.x += r.x * g.inverseMass), (g.positionPrev.y += r.y * g.inverseMass), (g.anglePrev += i.cross(P, r) * g.inverseInertia)),
                                                                y.isStatic || y.isSleeping || ((y.positionPrev.x -= r.x * y.inverseMass), (y.positionPrev.y -= r.y * y.inverseMass), (y.anglePrev -= i.cross(C, r) * y.inverseInertia));
                                                        }
                                                    }
                                                }
                                            });
                                    ...
                                    !(function () {
                                        (o.collides = function (e, t, n) {
                                            ...
                                            (u.bodyA = e.id < t.id ? e : t),
                                                ...
                                                (e = u.bodyA),
                                                (t = u.bodyB),
                                                i.dot(c.axis, i.sub(t.position, e.position)) < 0 ? (u.normal = { x: c.axis.x, y: c.axis.y }) : (u.normal = { x: -c.axis.x, y: -c.axis.y }),
                                            ...
                                            (o._overlapAxes = function (e, t, n) {
                                                for (var r, s, a = i._temp[0], c = i._temp[1], u = { overlap: Number.MAX_VALUE }, l = 0; l < n.length; l++) {
                                            ...
                                            (o._findSupports = function (e, t, n) {
                                                for (var o, r, s, a, c = Number.MAX_VALUE, u = i._temp[0], l = t.vertices, d = e.position, p = 0; p < l.length; p++)
                                                    (r = l[p]), (u.x = r.x - d.x), (u.y = r.y - d.y), (o = -i.dot(n, u)) < c && ((c = o), (s = r));
                                    ...
                                    !(function () {
                                        (o._warming = 0.4),
                                            ...
                                            (o.create = function (e) {
                                                ...
                                                return 0 === t.length && t.stiffness > 0.1 ? ((s.type = "pin"), (s.anchors = !1)) : t.stiffness < 0.9 && (s.type = "spring"), (t.render = u.extend(s, t.render)), t;
                                            }),
                                                ...
                                                if (n || r) {
                                                    ...
                                                    if ((n && (c = i.add(n.position, s)), r && (u = i.add(r.position, a)), c && u)) {
                                                        ...
                                                        n &&
                                                            ...
                                                            (n.position.x -= S.x * h),
                                                            (n.position.y -= S.y * h),
                                                            e.damping && ((n.positionPrev.x -= e.damping * f.x * g * h), (n.positionPrev.y -= e.damping * f.y * g * h)),
                                                            ...
                                                            r &&
                                                                ...
                                                                (r.position.x += S.x * h),
                                                                (r.position.y += S.y * h),
                                                                e.damping && ((r.positionPrev.x += e.damping * f.x * g * h), (r.positionPrev.y += e.damping * f.y * g * h)),
                                                    ...
                                                    if (!(n.isStatic || (0 === u.x && 0 === u.y && 0 === u.angle))) {
                                                        ...
                                                        for (var l = 0; l < n.parts.length; l++) {
                                                            ...
                                                            r.translate(d.vertices, u),
                                                                l > 0 && ((d.position.x += u.x), (d.position.y += u.y)),
                                                                0 !== u.angle && (r.rotate(d.vertices, u.angle, n.position), c.rotate(d.axes, u.angle), l > 0 && i.rotateAbout(d.position, u.angle, n.position, d.position)),
                                ...
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.create = function (e, t) {
                                            ...
                                            var r = u.create({ label: "Mouse Constraint", pointA: n.position, pointB: { x: 0, y: 0 }, length: 0.01, stiffness: 0.1, angularStiffness: 1, render: { strokeStyle: "#90EE90", lineWidth: 3 } }),
                                                i = { type: "mouseConstraint", mouse: n, element: null, body: null, constraint: r, collisionFilter: { category: 1, mask: 4294967295, group: 0 } },
                                                c = d.extend(i, t);
                                            return (
                                                            ...
                                                            if (((s = t[u]), p.contains(s.bounds, n.position) && c.canCollide(s.collisionFilter, e.collisionFilter)))
                                                                for (var l = s.parts.length > 1 ? 1 : 0; l < s.parts.length; l++) {
                                                                    ...
                                                                    if (r.contains(d.vertices, n.position)) {
                                                                        (o.pointA = n.position),
                                                                            (o.bodyB = e.body = s),
                                                                            (o.pointB = { x: n.position.x - s.position.x, y: n.position.y - s.position.y }),
                                                                            (o.angleB = s.angle),
                                                                            i.set(s, !1),
                                                ...
                                                (o._nextId = 0),
                                                    ...
                                                    (o.extend = function (e, t) {
                                                        ...
                                                        for (var i = n; i < arguments.length; i++) {
                                                            ...
                                                            if (s)
                                                                for (var a in s)
                                                                    r && s[a] && s[a].constructor === Object ? (e[a] && e[a].constructor !== Object ? (e[a] = s[a]) : ((e[a] = e[a] || {}), o.extend(e[a], r, s[a]))) : (e[a] = s[a]);
                                                        }
                                                        return e;
                                                    }),
                                    ...
                                    !(function () {
                                        (o.create = function (e, t) {
                                            ...
                                            var n = {
                                                    ...
                                                    broadphase: { controller: u },
                                                },
                                                o = h.extend(n, t);
                                            if (e || o.render) {
                                                var i = { element: e, controller: a };
                                            ...
                                            (o.update = function (e, t, n) {
                                                ...
                                                var g = { timestamp: u.timestamp };
                                                l.trigger(e, "beforeUpdate", g);
                                                var y = d.allBodies(a),
                                                    m = d.allConstraints(a);
                                                for (
                                                    e.enableSleeping && i.update(y, u.timeScale), o._bodiesApplyGravity(y, a.gravity), o._bodiesUpdate(y, t, u.timeScale, n, a.bounds), p.preSolveAll(y), r = 0;
                                                    r < e.constraintIterations;
                                                    r++
                                                )
                                                    p.solveAll(m, u.timeScale);
                                                p.postSolveAll(y),
                                                    h.controller ? (a.isModified && h.controller.clear(h), h.controller.update(h, y, e, a.isModified), (f = h.pairsList)) : (f = y),
                                                ...
                                                for (
                                                    c.update(S, v, w),
                                                        ...
                                                        S.collisionStart.length > 0 && l.trigger(e, "collisionStart", { pairs: S.collisionStart }),
                                                ...
                                                return (
                                                    S.collisionActive.length > 0 && l.trigger(e, "collisionActive", { pairs: S.collisionActive }),
                                                    S.collisionEnd.length > 0 && l.trigger(e, "collisionEnd", { pairs: S.collisionEnd }),
                                            ...
                                            (o.off = function (e, t, n) {
                                                if (t) {
                                                    ...
                                                    for (var o = t.split(" "), i = 0; i < o.length; i++) {
                                                        var s = e.events[o[i]],
                                                            a = [];
                                                        if (n && s) for (var c = 0; c < s.length; c++) s[c] !== n && a.push(s[c]);
                                                        e.events[o[i]] = a;
                                                    }
                                                } else e.events = {};
                                            }),
                                        ...
                                        (o.create = function (e) {
                                            ...
                                            return (
                                                ...
                                                (t.mousedown = function (e) {
                                                    var n = o._getRelativeMousePosition(e, t.element, t.pixelRatio),
                                                        r = e.changedTouches;
                                                    r ? ((t.button = 0), e.preventDefault()) : (t.button = e.button),
                                                        (t.absolute.x = n.x),
                                                        (t.absolute.y = n.y),
                                                        (t.position.x = t.absolute.x * t.scale.x + t.offset.x),
                                                        (t.position.y = t.absolute.y * t.scale.y + t.offset.y),
                                            ...
                                            (o._getRelativeMousePosition = function (e, t, n) {
                                                var o,
                                                    ...
                                                    u = e.changedTouches;
                                                return (
                                                    u ? ((o = u[0].pageX - i.left - a), (r = u[0].pageY - i.top - c)) : ((o = e.pageX - i.left - a), (r = e.pageY - i.top - c)),
                                                    { x: o / ((t.clientWidth / (t.width || t.clientWidth)) * n), y: r / ((t.clientHeight / (t.height || t.clientHeight)) * n) }
                                                );
                                            });
                                    })();
                                },
                                        ...
                                        (o._registry = {}),
                                            (o.register = function (e) {
                                                if ((o.isPlugin(e) || r.warn("Plugin.register:", o.toString(e), "does not implement all required fields."), e.name in o._registry)) {
                                                    ...
                                                    n > i
                                                        ? (r.warn("Plugin.register:", o.toString(t), "was upgraded to", o.toString(e)), (o._registry[e.name] = e))
                                                        : n < i
                                                        ? r.warn("Plugin.register:", o.toString(t), "can not be downgraded to", o.toString(e))
                                                        : e !== t && r.warn("Plugin.register:", o.toString(e), "is already registered to different plugin object");
                                                ...
                                                if (((e.uses = (e.uses || []).concat(t || [])), 0 !== e.uses.length)) {
                                                    for (var n = o.dependencies(e), i = r.topologicalSort(n), s = [], a = 0; a < i.length; a += 1)
                                                        if (i[a] !== e.name) {
                                                            ...
                                                            c
                                                                ? o.isUsed(e, c.name) ||
                                                                  (o.isFor(c, e) || (r.warn("Plugin.use:", o.toString(c), "is for", c.for, "but installed on", o.toString(e) + "."), (c._warned = !0)),
                                                                  c.install ? c.install(e) : (r.warn("Plugin.use:", o.toString(c), "does not specify an install function."), (c._warned = !0)),
                                                                  c._warned ? (s.push("🔶 " + o.toString(c)), delete c._warned) : s.push("✅ " + o.toString(c)),
                                                                  e.used.push(c.name))
                                                                : s.push("❌ " + i[a]);
                                                        }
                                                    ...
                                                    (e = o.resolve(e) || e),
                                                        (t[i] = r.map(e.uses || [], function (t) {
                                                            ...
                                                            var i = o.dependencyParse(t),
                                                                s = o.resolve(t);
                                                            return (
                                                                s && !o.versionSatisfies(s.version, i.range)
                                                                    ? (r.warn("Plugin.dependencies:", o.toString(s), "does not satisfy", o.toString(i), "used by", o.toString(n) + "."), (s._warned = !0), (e._warned = !0))
                                                                    : s || (r.warn("Plugin.dependencies:", o.toString(t), "used by", o.toString(n), "could not be resolved."), (e._warned = !0)),
                                                                i.name
                                                            );
                                                        }));
                                            ...
                                            (o.dependencyParse = function (e) {
                                                if (r.isString(e)) {
                                                    return (
                                                        /^[\w-]+(@(\*|[\^~]?\d+\.\d+\.\d+(-[0-9A-Za-z-]+)?))?$/.test(e) || r.warn("Plugin.dependencyParse:", e, "is not a valid dependency string."),
                                            ...
                                            (o.versionParse = function (e) {
                                                ...
                                                return { isRange: n, version: o, range: e, operator: n ? e[0] : "", parts: i, prerelease: t[1], number: 1e8 * i[0] + 1e4 * i[1] + i[2] };
                                            }),
                                        ...
                                        (o.create = function (e) {
                                            ...
                                            (o.tick = function (e, t, n) {
                                                ...
                                                r.trigger(e, "beforeTick", c),
                                                    ...
                                                    t.render &&
                                                        t.render.controller &&
                                                        (r.trigger(e, "beforeRender", c), r.trigger(t, "beforeRender", c), t.render.controller.world(t.render), r.trigger(e, "afterRender", c), r.trigger(t, "afterRender", c)),
                                                ...
                                                for (var n = t * t * t, r = 0; r < e.length; r++) {
                                                    ...
                                                    if (0 === i.force.x && 0 === i.force.y) {
                                                        ...
                                                        (i.motion = o._minBias * a + (1 - o._minBias) * c),
                                                            i.sleepThreshold > 0 && i.motion < o._motionSleepThreshold * n
                                                                ? ((i.sleepCounter += 1), i.sleepCounter >= i.sleepThreshold && o.set(i, !0))
                                                                : i.sleepCounter > 0 && (i.sleepCounter -= 1);
                                                    } else o.set(i, !1);
                                                }
                                            }),
                                ...
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.rectangle = function (e, t, n, o, r) {
                                            r = r || {};
                                            var c = { label: "Rectangle Body", position: { x: e, y: t }, vertices: i.fromPath("L 0 0 L " + n + " 0 L " + n + " " + o + " L 0 " + o) };
                                            if (r.chamfer) {
                                                var u = r.chamfer;
                                            ...
                                            (o.trapezoid = function (e, t, n, o, r, c) {
                                                ...
                                                var u,
                                                    ...
                                                    p = d + l,
                                                    h = p + d;
                                                u = r < 0.5 ? "L 0 0 L " + d + " " + -o + " L " + p + " " + -o + " L " + h + " 0" : "L 0 0 L " + p + " " + -o + " L " + h + " 0";
                                                var f = { label: "Trapezoid Body", position: { x: e, y: t }, vertices: i.fromPath(u) };
                                                if (c.chamfer) {
                                                    var g = c.chamfer;
                                            ...
                                            (o.polygon = function (e, t, n, r, c) {
                                                ...
                                                for (var u = (2 * Math.PI) / n, l = "", d = 0.5 * u, p = 0; p < n; p += 1) {
                                                    var h = d + p * u,
                                                        f = Math.cos(h) * r,
                                                        g = Math.sin(h) * r;
                                                    l += "L " + f.toFixed(3) + " " + g.toFixed(3) + " ";
                                                }
                                                var y = { label: "Polygon Body", position: { x: e, y: t }, vertices: i.fromPath(l) };
                                                if (c.chamfer) {
                                                    var m = c.chamfer;
                                            ...
                                            (o.fromVertices = function (e, t, n, o, l, d, p) {
                                                ...
                                                for (
                                                    r || (r = s._requireGlobal("decomp", "poly-decomp")),
                                                        o = o || {},
                                                        f = [],
                                                        l = void 0 !== l && l,
                                                        d = void 0 !== d ? d : 0.01,
                                                    ...
                                                    if (((y = n[w]), (g = i.isConvex(y)) || !r)) (y = g ? i.clockwiseSort(y) : i.hull(y)), f.push({ position: { x: e, y: t }, vertices: y });
                                                    else {
                                                        ...
                                                        for (m = 0; m < _.length; m++) {
                                                            ...
                                                            (p > 0 && i.area(C) < p) || f.push({ position: i.centre(C), vertices: C });
                                                        }
                                                    }
                                                ...
                                                return f.length > 1 ? ((h = a.create(s.extend({ parts: f.slice(0) }, o))), a.setPosition(h, { x: e, y: t }), h) : f[0];
                                            });
                                    })();
                                },
                                ...
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.stack = function (e, t, n, o, i, s, c) {
                                            for (var u, l = r.create({ label: "Stack" }), d = e, p = t, h = 0, f = 0; f < o; f++) {
                                                for (var g = 0, y = 0; y < n; y++) {
                                                    var m = c(d, p, y, f, u, h);
                                                    if (m) {
                                                        var v = m.bounds.max.y - m.bounds.min.y,
                                                            S = m.bounds.max.x - m.bounds.min.x;
                                                        v > g && (g = v), a.translate(m, { x: 0.5 * S, y: 0.5 * v }), (d = m.bounds.max.x + i), r.addBody(l, m), (u = m), (h += 1);
                                                    } else d += i;
                                                }
                                                (p += g + s), (d = e);
                                            }
                                            ...
                                            (o.chain = function (e, t, n, o, a, c) {
                                                for (var u = e.bodies, l = 1; l < u.length; l++) {
                                                    var d = u[l - 1],
                                                        ...
                                                        m = { bodyA: d, pointA: { x: f * t, y: h * n }, bodyB: p, pointB: { x: y * o, y: g * a } },
                                                        v = s.extend(m, c);
                                            ...
                                            (o.mesh = function (e, t, n, o, a) {
                                                var c,
                                                    ...
                                                    h = e.bodies;
                                                for (c = 0; c < n; c++) {
                                                    for (u = 1; u < t; u++) (l = h[u - 1 + c * t]), (d = h[u + c * t]), r.addConstraint(e, i.create(s.extend({ bodyA: l, bodyB: d }, a)));
                                                    if (c > 0)
                                                        for (u = 0; u < t; u++)
                                                            (l = h[u + (c - 1) * t]),
                                                                (d = h[u + c * t]),
                                                                r.addConstraint(e, i.create(s.extend({ bodyA: l, bodyB: d }, a))),
                                                                o && u > 0 && ((p = h[u - 1 + (c - 1) * t]), r.addConstraint(e, i.create(s.extend({ bodyA: p, bodyB: d }, a)))),
                                                                o && u < t - 1 && ((p = h[u + 1 + (c - 1) * t]), r.addConstraint(e, i.create(s.extend({ bodyA: p, bodyB: d }, a))));
                                                }
                                                ...
                                                return o.stack(e, t, n, r, i, s, function (t, o, s, u, l, d) {
                                                    ...
                                                    if (!(u > p)) {
                                                        var f = (u = p - u),
                                                            g = n - 1 - u;
                                                        if (!(s < f || s > g)) {
                                                            1 === d && a.translate(l, { x: (s + (n % 2 == 1 ? 1 : -1)) * h, y: 0 });
                                                            var y = l ? s * h : 0;
                                            ...
                                            (o.newtonsCradle = function (e, t, n, o, s) {
                                                for (var a = r.create({ label: "Newtons Cradle" }), u = 0; u < n; u++) {
                                                    var l = c.circle(e + u * (1.9 * o), t + s, o, { inertia: 1 / 0, restitution: 1, friction: 0, frictionAir: 1e-4, slop: 1 }),
                                                        d = i.create({ pointA: { x: e + u * (1.9 * o), y: t }, bodyB: l });
                                            ...
                                            (o.car = function (e, t, n, o, s) {
                                                var u = a.nextGroup(!0),
                                                    ...
                                                    h = c.rectangle(e, t, n, o, { collisionFilter: { group: u }, chamfer: { radius: 0.5 * o }, density: 2e-4 }),
                                                    f = c.circle(e + l, t + 0, s, { collisionFilter: { group: u }, friction: 0.8 }),
                                                    g = c.circle(e + d, t + 0, s, { collisionFilter: { group: u }, friction: 0.8 }),
                                                    y = i.create({ bodyB: h, pointB: { x: l, y: 0 }, bodyA: f, stiffness: 1, length: 0 }),
                                                    m = i.create({ bodyB: h, pointB: { x: d, y: 0 }, bodyA: g, stiffness: 1, length: 0 });
                                    ...
                                    !(function () {
                                        (o.fromVertices = function (e) {
                                            for (var t = {}, n = 0; n < e.length; n++) {
                                                var o = (n + 1) % e.length,
                                                    s = r.normalise({ x: e[o].y - e[n].y, y: e[n].x - e[o].x }),
                                                    a = 0 === s.y ? 1 / 0 : s.x / s.y;
                                            ...
                                            (o._svgPathToAbsolute = function (e) {
                                                for (var t, n, o, r, i, s, a = e.pathSegList, c = 0, u = 0, l = a.numberOfItems, d = 0; d < l; ++d) {
                                                    ...
                                                    if (/[MLHVCSQTA]/.test(h)) "x" in p && (c = p.x), "y" in p && (u = p.y);
                                                        ...
                                                        switch (("x1" in p && (o = c + p.x1), "x2" in p && (i = c + p.x2), "y1" in p && (r = u + p.y1), "y2" in p && (s = u + p.y2), "x" in p && (c += p.x), "y" in p && (u += p.y), h)) {
                                                            case "m":
                                ...
                                function (e, t, n) {
                                    ...
                                    !(function () {
                                        (o.create = function (e, t) {
                                            for (var n = [], o = 0; o < e.length; o++) {
                                                var r = e[o],
                                                    i = { x: r.x, y: r.y, index: o, body: t, isInternal: !1 };
                                                n.push(i);
                                            }
                                            return n;
                                        }),
                                            ...
                                            (o.centre = function (e) {
                                                for (var t, n, i, s = o.area(e, !0), a = { x: 0, y: 0 }, c = 0; c < e.length; c++) (i = (c + 1) % e.length), (t = r.cross(e[c], e[i])), (n = r.mult(r.add(e[c], e[i]), t)), (a = r.add(a, n));
                                                return r.div(a, 6 * s);
                                            }),
                                            (o.mean = function (e) {
                                            ...
                                            (o.inertia = function (e, t) {
                                                for (var n, o, i = 0, s = 0, a = e, c = 0; c < a.length; c++)
                                                    (o = (c + 1) % a.length), (n = Math.abs(r.cross(a[o], a[c]))), (i += n * (r.dot(a[o], a[o]) + r.dot(a[o], a[c]) + r.dot(a[c], a[c]))), (s += n);
                                                return (t / 6) * (i / s);
                                            }),
                                            (o.translate = function (e, t, n) {
                                                var o;
                                            ...
                                            (o.chamfer = function (e, t, n, o, s) {
                                                ...
                                                for (var a = [], c = 0; c < e.length; c++) {
                                                    ...
                                                    if (0 !== p) {
                                                        var h = r.normalise({ x: l.y - u.y, y: u.x - l.x }),
                                                            f = r.normalise({ x: d.y - l.y, y: l.x - d.x }),
                                                            g = Math.sqrt(2 * Math.pow(p, 2)),
                                                            y = r.mult(i.clone(h), p),
                                                            m = r.normalise(r.mult(r.add(h, f), 0.5)),
                                                            v = r.sub(l, r.mult(m, g)),
                                                            S = n;
                                                        -1 === n && (S = 1.75 * Math.pow(p, 0.32)), (S = i.clamp(S, o, s)) % 2 == 1 && (S += 1);
                                        ...
                                        "undefined" != typeof window &&
                                            ...
                                            (o.create = function (e) {
                                                var t = {
                                                    ...
                                                    i = r.extend(t, e);
                                                return (
                                                    i.canvas && ((i.canvas.width = i.options.width || i.canvas.width), (i.canvas.height = i.options.height || i.canvas.height)),
                                                    (i.mouse = e.mouse),
                                                    (i.engine = e.engine),
                                                    (i.canvas = i.canvas || n(i.options.width, i.options.height)),
                                                    (i.context = i.canvas.getContext("2d")),
                                                    (i.textures = {}),
                                                    (i.bounds = i.bounds || { min: { x: 0, y: 0 }, max: { x: i.canvas.width, y: i.canvas.height } }),
                                            ...
                                            (o.lookAt = function (e, t, n, o) {
                                                ...
                                                for (var i = { min: { x: 1 / 0, y: 1 / 0 }, max: { x: -1 / 0, y: -1 / 0 } }, s = 0; s < t.length; s += 1) {
                                                    var a = t[s],
                                                ...
                                                y > g ? (v = y / g) : (m = g / y),
                                                    ...
                                                    o && ((e.bounds.min.x += 0.5 * d - d * m * 0.5), (e.bounds.max.x += 0.5 * d - d * m * 0.5), (e.bounds.min.y += 0.5 * p - p * v * 0.5), (e.bounds.max.y += 0.5 * p - p * v * 0.5)),
                                                    (e.bounds.min.x -= n.x),
                                                    (e.bounds.max.x -= n.x),
                                                    (e.bounds.min.y -= n.y),
                                                    (e.bounds.max.y -= n.y),
                                                    e.mouse && (l.setScale(e.mouse, { x: (e.bounds.max.x - e.bounds.min.x) / e.canvas.width, y: (e.bounds.max.y - e.bounds.min.y) / e.canvas.height }), l.setOffset(e.mouse, e.bounds.min));
                                            }),
                                            ...
                                            (o.world = function (e) {
                                                var t,
                                                    ...
                                                    v = [],
                                                    S = [],
                                                    w = { timestamp: n.timing.timestamp };
                                                if (
                                                    (a.trigger(e, "beforeRender", w),
                                                ...
                                                !f.wireframes || (n.enableSleeping && f.showSleeping) ? o.bodies(e, v, p) : (f.showConvexHulls && o.bodyConvexHulls(e, v, p), o.bodyWireframes(e, v, p)),
                                                        ...
                                                        if (((s = c ? u.add(c.position, i.pointA) : i.pointA), "pin" === i.render.type)) n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.closePath();
                                                            ...
                                                            if (((a = l ? u.add(l.position, i.pointB) : i.pointB), n.beginPath(), n.moveTo(s.x, s.y), "spring" === i.render.type))
                                                                for (var d, p = u.sub(a, s), h = u.perp(u.normalise(p)), f = Math.ceil(r.clamp(i.length / 5, 12, 20)), g = 1; g < f; g += 1)
                                                                    (d = g % 2 == 0 ? 1 : -1), n.lineTo(s.x + p.x * (g / f) + h.x * d * 4, s.y + p.y * (g / f) + h.y * d * 4);
                                                            n.lineTo(a.x, a.y);
                                                        }
                                                        i.render.lineWidth && ((n.lineWidth = i.render.lineWidth), (n.strokeStyle = i.render.strokeStyle), n.stroke()),
                                                            i.render.anchors && ((n.fillStyle = i.render.strokeStyle), n.beginPath(), n.arc(s.x, s.y, 3, 0, 2 * Math.PI), n.arc(a.x, a.y, 3, 0, 2 * Math.PI), n.closePath(), n.fill());
                                                    }
                                                }
                                            }),
                                            (o.bodyShadows = function (e, t, n) {
                                                for (var o = n, r = (e.engine, 0); r < t.length; r++) {
                                                    ...
                                                    if (i.render.visible) {
                                                        ...
                                                        var a = i.position.x - 0.5 * e.options.width,
                                                            c = i.position.y - 0.2 * e.options.height,
                                                            u = Math.abs(a) + Math.abs(c);
                                                        (o.shadowColor = "rgba(0,0,0,0.15)"),
                                                            (o.shadowOffsetX = 0.05 * a),
                                                            (o.shadowOffsetY = 0.05 * c),
                                                    ...
                                                    if ((o = t[i]).render.visible)
                                                        for (s = o.parts.length > 1 ? 1 : 0; s < o.parts.length; s++)
                                                            if ((r = o.parts[s]).render.visible) {
                                                                if (
                                                                    (c.showSleeping && o.isSleeping ? (a.globalAlpha = 0.5 * r.render.opacity) : 1 !== r.render.opacity && (a.globalAlpha = r.render.opacity),
                                                ...
                                                for (c.beginPath(), i = 0; i < t.length; i++)
                                                    if ((o = t[i]).render.visible)
                                                        for (a = o.parts.length > 1 ? 1 : 0; a < o.parts.length; a++) {
                                                            for (r = o.parts[a], c.moveTo(r.vertices[0].x, r.vertices[0].y), s = 1; s < r.vertices.length; s++)
                                                ...
                                                for (o = 0; o < t.length; o++) {
                                                    ...
                                                    for (i = a.length > 1 ? 1 : 0; i < a.length; i++) {
                                                        ...
                                                        for (r = 0; r < c.vertices.length; r++)
                                                            (s.fillStyle = "rgba(255,255,255,0.2)"), s.fillText(o + "_" + r, c.position.x + 0.8 * (c.vertices[r].x - c.position.x), c.position.y + 0.8 * (c.vertices[r].y - c.position.y));
                                                    }
                                                }
                                            }),
                                            ...
                                            (o.bodyAxes = function (e, t, n) {
                                                ...
                                                c.wireframes ? ((a.strokeStyle = "indianred"), (a.lineWidth = 1)) : ((a.strokeStyle = "rgba(255, 255, 255, 0.4)"), (a.globalCompositeOperation = "overlay"), (a.lineWidth = 2)),
                                                    a.stroke(),
                                            ...
                                            (o.bodyPositions = function (e, t, n) {
                                                ...
                                                for (a.beginPath(), i = 0; i < t.length; i++)
                                                    if ((o = t[i]).render.visible) for (s = 0; s < o.parts.length; s++) (r = o.parts[s]), a.arc(r.position.x, r.position.y, 3, 0, 2 * Math.PI, !1), a.closePath();
                                                for (c.wireframes ? (a.fillStyle = "indianred") : (a.fillStyle = "rgba(0,0,0,0.5)"), a.fill(), a.beginPath(), i = 0; i < t.length; i++)
                                                    (o = t[i]).render.visible && (a.arc(o.positionPrev.x, o.positionPrev.y, 2, 0, 2 * Math.PI, !1), a.closePath());
                                            ...
                                            (o.grid = function (e, t, n) {
                                                ...
                                                for (var s = r.keys(t.buckets), a = 0; a < s.length; a++) {
                                                    ...
                                                    if (!(t.buckets[c].length < 2)) {
                                                        var u = c.split(/C|R/);
                                                        o.rect(0.5 + parseInt(u[1], 10) * t.bucketWidth, 0.5 + parseInt(u[2], 10) * t.bucketHeight, t.bucketWidth, t.bucketHeight);
                                                    }
                                                }
                                            ...
                                            (o.inspector = function (e, t) {
                                                ...
                                                for (var l = 0; l < o.length; l++) {
                                                    var d = o[l].data;
                                                    switch ((t.translate(0.5, 0.5), (t.lineWidth = 1), (t.strokeStyle = "rgba(255,165,0,0.9)"), t.setLineDash([1, 2]), d.type)) {
                                                        case "body":
                                                            (n = d.bounds),
                                                                t.beginPath(),
                                    ...
                                    !(function () {
                                        ...
                                        "undefined" != typeof window &&
                                            ...
                                            (o.create = function (e) {
                                                ...
                                                return (
                                                    (n.pixiOptions = n.pixiOptions || { view: n.canvas, transparent: r, antialias: !0, backgroundColor: e.background }),
                                                    (n.mouse = e.mouse),
                                                    (n.engine = e.engine),
                                                    ...
                                                    (n.bounds = n.bounds || { min: { x: 0, y: 0 }, max: { x: n.options.width, y: n.options.height } }),
                                            ...
                                            (o.constraint = function (e, t) {
                                                ...
                                                l || (l = e.primitives[u] = new PIXI.Graphics()),
                                                    c.visible && t.pointA && t.pointB
                                                        ? (-1 === s.indexOf(a.children, l) && a.addChild(l),
                                                          l.clear(),
                                                          l.beginFill(0, 0),
                                        ...
                                        var n = function (e, t) {
                                            ...
                                            u = function (e, t) {
                                                ...
                                                for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
                                                    (n = t.parts[p]),
                                                        r.wireframes ? (i.beginFill(0, 0), i.lineStyle(1, l, 1)) : (i.beginFill(a, 1), i.lineStyle(o.lineWidth, c, 1)),
    ...
    "./source/js/application.js": function (e, t, n) {
        ...
        (function (e) {
            ...
            var o = [n("./source/img/cats/cat_1.png"), n("./source/img/cats/cat_2.png"), n("./source/img/cats/cat_3.png"), n("./source/img/cats/cat_4.png"), n("./source/img/cats/cat_5.png"), n("./source/img/cats/cat_6.png")],
                r = [
                    n("./source/img/rainbow/cat_1.png"),
                    n("./source/img/rainbow/cat_2.png"),
                    n("./source/img/rainbow/cat_3.png"),
                    n("./source/img/rainbow/cat_4.png"),
                    n("./source/img/rainbow/cat_5.png"),
                    n("./source/img/rainbow/cat_6.png"),
                ],
                i = t.default.Engine,
                s = t.default.Render,
                a = t.default.World,
                ...
                _ = function () {
                    ...
                    (m = e(window).width()), (v = e(window).height()), (S = m >= 415 ? 1 : 0.5), (w = m >= 415 ? 1 : 0.5), a.clear(h.world), i.clear(h), ((h = i.create({})).timing.timeScale = 1);
                    var n = s.create({
                        element: document.getElementById("cat-bounce"),
                        engine: h,
                        setPixelRatio: "auto",
                        options: { showAngleIndicator: !1, showInternalEdges: !1, showDebug: !1, wireframes: !1, background: "transparent", width: m, height: v },
                    });
                    (document.body.style.backgroundImage = "linear-gradient(180deg, " + t + ", #fff)"),
                        a.add(h.world, [
                            c.rectangle(m / 2, v + 50, m, 100, { isStatic: !0 }),
                            c.rectangle(m / 2, -1e3, m, 100, { isStatic: !0 }),
                            c.rectangle(-50, v / 2, 100, v, { isStatic: !0 }),
                            c.rectangle(m + 50, v / 2, 100, v, { isStatic: !0 }),
                        ]),
                        o.forEach(function (e, t) {
                            (g[t] = c.circle(Math.random() * m, Math.random() * v - v, 100, {
                                ...
                                render: { sprite: { texture: e, xScale: S, yScale: w } },
                            })),
                                a.add(h.world, g[t]);
                        });
                    var r = p.create(n.canvas),
                        u = d.create(h, { mouse: r, constraint: { stiffness: 0.2, render: { visible: !1 } } });
                    ...
                    return l.stack(0, 2.55 * -o, 10, 8, b(0, 50), b(0, 50), function (e, n) {
                        return (
                            ...
                            c.circle(e, n, 100, {
                                ...
                                frictionStatic: 15,
                                density: 0.01,
                                collisionFilter: { category: 2, mask: 14 },
                                render: { sprite: { texture: t[s++], xScale: r, yScale: i } },
                            })
                        );
                    });
                })(n);
                a.add(h.world, d),
                    1 === i
                        ? d.bodies.forEach(function (e, t) {
                              u.setAngularVelocity(e, 0.02 * b(-5, 5)), u.setVelocity(e, { x: 0, y: 30 });
                          })
                        : d.bodies.forEach(function (e, t) {
                              u.setAngularVelocity(e, 0.02 * b(-5, 5)), u.setVelocity(e, { x: 0, y: 15 });
                          }),
                    (s.onended = function () {
                        ...
                        function (e, t, n) {
                            function o(e, t, n) {
                                ...
                                return (
                                    ...
                                    (a = t[0][0] - t[1][0]),
                                    (c = s * t[0][0] + a * t[0][1]),
                                    b((u = o * a - s * r), 0, n) || ((l[0] = (a * i - r * c) / u), (l[1] = (o * c - s * i) / u)),
                                    l
                                );
                            }
                            function r(e, t, n, o) {
                            ...
                            t.exports = {
                                ...
                                quickDecomp: function e(t, n, o, r, i, l, d) {
                                    ...
                                    for (var L = 0; L < t.length; ++L)
                                        if (y(G, L)) {
                                            ...
                                            for (var O = 0; O < t.length; ++O)
                                                s(f(G, L - 1), f(G, L), f(G, O)) &&
                                                    u(f(G, L - 1), f(G, L), f(G, O - 1)) &&
                                                    ((v = x(f(G, L - 1), f(G, L), f(G, O), f(G, O - 1))), c(f(G, L + 1), f(G, L), v) && (b = h(G[L], v)) < w && ((w = b), (m = v), (C = O))),
                                                    s(f(G, L + 1), f(G, L), f(G, O + 1)) &&
                                                        u(f(G, L + 1), f(G, L), f(G, O)) &&
                                                        ((v = x(f(G, L + 1), f(G, L), f(G, O), f(G, O + 1))), s(f(G, L - 1), f(G, L), v) && (b = h(G[L], v)) < S && ((S = b), (p = v), (P = O)));
                                            if (C === (P + 1) % t.length)
                                                (v[0] = (m[0] + p[0]) / 2),
                                                    (v[1] = (m[1] + p[1]) / 2),
                                                    r.push(v),
                                                    L < P
                                                        ? (g(V, G, L, P + 1), V.push(v), T.push(v), 0 !== C && g(T, G, C, G.length), g(T, G, 0, L + 1))
                                                        : (0 !== L && g(V, G, L, G.length), g(V, G, 0, P + 1), V.push(v), T.push(v), g(T, G, C, L + 1));
                                            else {
                                ...
                                isSimple: function (e) {
                                    var t,
                                        n = e;
                                    for (t = 0; t < n.length - 1; t++) for (var o = 0; o < t - 1; o++) if (r(n[t], n[t + 1], n[o], n[o + 1])) return !1;
                                    for (t = 1; t < n.length - 2; t++) if (r(n[0], n[n.length - 1], n[t], n[t + 1])) return !1;
                                    return !0;
                                },
                            ...
                            function S(e, t, n) {
                                ...
                                for (var l = 0; l !== e.length; ++l)
                                    if (
                                        (l + 1) % e.length !== t &&
                                        l !== t &&
                                        a(f(e, t), f(e, n), f(e, l + 1)) &&
                                        u(f(e, t), f(e, n), f(e, l)) &&
                                        ((s[0] = f(e, t)), (s[1] = f(e, n)), (c[0] = f(e, l)), (c[1] = f(e, l + 1)), (r = o(s, c)), h(f(e, t), r) < i)
                                    )
                                        return !1;
                                return !0;
                            }
        ...
        !(function () {
            "SVGPathSeg" in window ||
                ...
                "getPathSegAtLength" in window.SVGPathElement.prototype ||
                    (window.SVGPathElement.prototype.getPathSegAtLength = function (e) {
                    ...
                    (window.SVGPathSegList.prototype._parsePath = function (e) {
                        ...
                        (o.prototype._isCurrentSpace = function () {
                            ...
                            (o.prototype._nextCommandHelper = function (e, t) {
                                return ("+" == e || "-" == e || "." == e || (e >= "0" && e <= "9")) && t != window.SVGPathSeg.PATHSEG_CLOSEPATH
                            ...
                            (o.prototype._parseNumber = function () {
                                ...
                                if (
                                    ...
                                    if (this._currentIndex != a) for (var c = this._currentIndex - 1, u = 1; c >= a; ) (t += u * (this._string.charAt(c--) - "0")), (u *= 10);
                                    if (this._currentIndex < this._endIndex && "." == this._string.charAt(this._currentIndex)) {
                                        ...
                                        for (; this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9"; )
                                            (n *= 10), (o += (this._string.charAt(this._currentIndex) - "0") / n), (this._currentIndex += 1);
                                    }
                                    if (
                                        ...
                                        if (
                                            (this._currentIndex++,
                                            "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, (i = -1)),
                                            this._currentIndex >= this._endIndex || this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9")
                                        )
                                            return;
                                        for (; this._currentIndex < this._endIndex && this._string.charAt(this._currentIndex) >= "0" && this._string.charAt(this._currentIndex) <= "9"; )
                                            (e *= 10), (e += this._string.charAt(this._currentIndex) - "0"), this._currentIndex++;
                                    }
                                    var l = t + o;
                            ...
                            (o.prototype.parseSegment = function () {
                                ...
                                switch (((this._previousCommand = n), n)) {
                                    ...
                                    case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL:
                                        var o = { x1: this._parseNumber(), y1: this._parseNumber(), x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() };
                                        return new window.SVGPathSegCurvetoCubicRel(t, o.x, o.y, o.x1, o.y1, o.x2, o.y2);
                                    case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS:
                                        o = { x1: this._parseNumber(), y1: this._parseNumber(), x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() };
                                        return new window.SVGPathSegCurvetoCubicAbs(t, o.x, o.y, o.x1, o.y1, o.x2, o.y2);
                                    case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL:
                                        o = { x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() };
                                    ...
                                    case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL:
                                        o = { x1: this._parseNumber(), y1: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() };
                                    ...
                                    case window.SVGPathSeg.PATHSEG_ARC_REL:
                                        o = { x1: this._parseNumber(), y1: this._parseNumber(), arcAngle: this._parseNumber(), arcLarge: this._parseArcFlag(), arcSweep: this._parseArcFlag(), x: this._parseNumber(), y: this._parseNumber() };
    ...
    "./source/js/wobbler.js": function (e, t, n) {
        ...
        for (a.setAttribute("id", "wobble"), a.setAttribute("class", "btn italic"), a.innerText = "Paraplegic Metapod", document.body.appendChild(a), o = a.firstChild.nodeValue; a.childNodes.length; ) a.removeChild(a.childNodes[0]);
